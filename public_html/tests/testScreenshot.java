...
public class testScreenshot {
    ...
    public void tirarScreenshot(){
        ...
        //Quando o sistema possui janelas com java script é utilizado o método switchTo()
        //o método switchTo significa a transferencia para um diferente contexto
        //Pagina do sistema > Janela de confirmação (javascript)
        ...
        assertEquals("_Administradores", validarCliente);

        //Utilização da classe Screnshot
        //Screenshot.tirar(navegador, "F:\\Projetos Selenium\\Screenshots" + Generator.dataHoraParaArquivo() + "validaçãoDoLoginDoClienteEscolhido.png");

        //Captura do nome do método
        //Screenshot.tirar(navegador, "F:\\Projetos Selenium\\Screenshots" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png");

        //Forma mais organizada
        String screenshotArquivo = "F:\\Projetos Selenium\\Screenshots\\" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
